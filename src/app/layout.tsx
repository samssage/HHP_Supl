      ...
      <body className="min-h-full flex flex-col font-sans">
        <header className="no-print sticky top-0 z-20 border-b border-line bg-surface/95 backdrop-blur">
          <div className="mx-auto flex max-w-5xl items-center gap-4 px-4 py-3">
            ...
            <nav className="ml-auto hidden gap-1 text-sm md:flex">
              {NAV.map((n) => (
        ...
        <nav className="no-print fixed inset-x-0 bottom-0 z-20 grid grid-cols-5 border-t border-line bg-surface text-xs md:hidden">
          {NAV.map((n) => (
